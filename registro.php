<?php
  ...
  $template->setVariable("verificapasswrd","verificar($passwrd1, $passwrd2)");
  $template->setVariable("verificapasswrd1","verificar($passwrd1, $passwrd2)");
  $template->setVariable("matches","");
